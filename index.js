...
angular.module('nwas', ['ngSanitize', 'pascalprecht.translate']).controller('main', function($scope, $http, apps, $translate) {
  ...
  $scope.upload = function upload() {
    ...
    navigator.usb.requestDevice({
      ...
      async selectedDevice => {
        ...
        let archive = await loadFirmwareFile("apps.tar");//await buildArchive($scope.selectedApps, $scope.customFiles);
  ...
  $translateProvider
    ...
    .translations('fr', {
      ...
      FIRMWARE: 'Pour installer un micrologiciel compatible, cliquez ',
